...
const ProbabilityExperimentComponent = (props: RouteComponentProps) => {
  ...
  // 排序题 start
  //renderEmptyCards start
  const renderEmptyCards = () => {
    return (
      <div className={styles.BoxWrapper}>
        <div className={styles.BoxGroup}>
          <div className={styles.BoxItem}>{renderCard(state.probabilityExperimentSteps[0].name, 0)}</div>
        </div>
        ...
        <div className={styles.BoxGroup}>
          <div className={styles.BoxItem}>{renderCard(state.probabilityExperimentSteps[1].name, 1)}</div>
        </div>
        <div className={styles.ArrowGroup}>
          <div className={styles.ArrowBox}>
            <img className={styles.Arrow} src={Arrow} alt="箭头" />
        ...
        <div className={styles.BoxGroup}>
          <div className={styles.BoxItem}>{renderCard(state.probabilityExperimentSteps[2].name, 2)}</div>
        </div>
        <div className={styles.ArrowGroup}>
          <div className={styles.ArrowBox}>
            <img className={styles.Arrow} src={Arrow} alt="箭头" />
        ...
        <div className={styles.BoxGroup}>
          <div className={styles.BoxItem}>{renderCard(state.probabilityExperimentSteps[3].name, 3)}</div>
        </div>
      </div>
    )
  }
...
`
  ...
  //renderParamSection end

  //renderSelectSection start
  /**
   * 模型调试区域
   */
  ...
  //renderSearchForm end
  //renderSearchSteps start
  /**
   * 仿真我的搜索引擎
   */
  ...
  //renderSearchSteps end

  // renderSearchResult start
  /**
   * 渲染搜索结果
   */
