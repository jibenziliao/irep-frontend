  ...
  const ResultList=[
    {
      ...
      url:'http://mc.163.com/',
      content:'网易游戏代理的《我的世界》(Minecraft)手游,你想玩的,这里都有!作为中国顶尖UGC游戏平台,《我的世界》汇聚全球优秀创造者提供海量玩法内容。赶紧和你的小伙伴一...',
    },
    {
      ...
      return ResultList.map(i => {
        return (
          <div className={styles.Result}>
            <a className={styles.resultTitle} href={i.url}>{i.title}</a>
    ...
    <div className={styles.Container}>
      ...
      <div className={styles.Content}>
        <div className={styles.MiddleSection} hidden={!serachResult}>
          ...
          <Search className={styles.InputSection} placeholder="输入检索式" enterButton="搜索" size="large" onSearch={handleSearch}/>
        </div>
        <div hidden={serachResult}>
          <div className={styles.topSection}>
            <div className={styles.topTitle}>仿真我的搜索引擎</div>
            <Search className={styles.InputSection} placeholder={search} enterButton="搜索" size="large" onSearch={handleSearch}/>
          </div>
