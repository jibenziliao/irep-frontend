    ...
    return(
        <div className={styles.wordSection}>
            ...
            <div className={styles.wordCloudChoose}>
                ...
                <Button className={styles.button} onClick={segmentConfirm}>分析</Button>
            </div>
        </div>
    )
}
    ...
    return(
        <div className={styles.Section}>
            ...
            <div className={styles.concludeSection}>
                ...
                <TextArea rows={6} />
                <Button className={styles.button} onClick={concludeConfirm}>确定</Button>
            </div>
            <div className={styles.experimentSection}>
                ...
                <div className={styles.experimentChoose}>
                    ...
                    <Button className={styles.button} onClick={handelAnalyze}>分析</Button>
                </div>
                <div className={styles.SectionTitle}>预处理结果：</div>
                <div className={styles.resultBox}>{segmentResult}</div>
                <Button onClick={handleClick} className={styles.button} disabled={experimentDisabled}>下一步</Button>
            </div>
