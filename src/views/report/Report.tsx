      ...
      <div className={styles.Content}>
        <div className={styles.Report}>
          ...
          <div className={styles.reporTop}>
            <div>姓名：<input className={styles.topInput} value={name} disabled></input></div>
            <div>学号：<input className={styles.topInput} value={number} disabled></input></div>
            <div>班级：<input className={styles.topInput} value={studentClass} disabled></input></div>
            <div>评分：<input className={styles.topInput} value={score} disabled></input></div>
          </div>
          <div className={styles.reporTop2}>
            <div>实验名称：<input className={styles.topInput2} value="网络大数据搜索引擎设计虚拟仿真实验" disabled></input></div>
            <div>实验日期：<input className={styles.topInput3} value={time} disabled></input></div>
          </div>
          <h2>实验结果与分析：</h2>
          <Table
            columns={columns}
