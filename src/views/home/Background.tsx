        ...
        <div className={styles.rightDiv}>
          <div className={styles.mainContent}>
            ...
            <div className={styles.texts}>
              ...
              <div>
                2.搭建搜索引擎所涉及技术与算法繁多复杂，在实际生产中往往需要多位有多年算法和架构经验的工程师才能实现。
                <span>(难度大)</span>
                信息管理与信息系统专业学生所掌握计算机软件与编程方面的知识对于完成该任务依然相去甚远。
              </div>
              <div>
                3.评价搜索引擎性能是搭建网络搜索引擎的重要任务之一。实现该任务需要花费一定的人力物力构建一定量的标准数据集。
                <span>(成本高)</span>
                同时也许搭建专业的性能评价软件。用于测试检索系统性能的数据集往往是各大公司的商业机密。因此以往的教学实践中，该部分的内容仅限于理论课教学，学生缺乏实践机会。
              </div>
              <div>
